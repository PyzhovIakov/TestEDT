...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Движение.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.Валюта]=Договор.Валюта;
	Движение.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконто.Договор]=Договор;

	Движение.СуммаРубДт = СписокНоменклатуры.Итог("Сумма");
	Движение.СуммаРубКт = СписокНоменклатуры.Итог("Сумма");

	КурсВалюты = РегистрыСведений.КурсыВалют.ПолучитьПоследнее(Дата, Новый структура("Валюта", Договор.Валюта));
	Движение.СуммаВалДт = СписокНоменклатуры.Итог("Сумма") / КурсВалюты.Курс;
	Движение.СуммаВалКт =  СписокНоменклатуры.Итог("Сумма") / КурсВалюты.Курс;
